	...
	_createClass(_class, [{
		...
		value: function render() {
			...
			children = children.map(function (child) {
				...
				return _react2['default'].addons.cloneWithProps(child, { style: (_style = {}, _defineProperty(_style, key, (+child.props.weight || 1) * 100 / total + '%'), _defineProperty(_style, minkey, (+child.props.weight || 1) * 100 / total + '%'), _defineProperty(_style, 'display', 'inline-block'), _style) });
			});
