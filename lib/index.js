...
var Weighted = (function (_React$Component) {
	...
	_createClass(Weighted, [{
		...
		value: function render() {
			...
			var _ref2 = column ? ['height', 'width'] : ['width', 'height'];

			var _ref22 = _slicedToArray(_ref2, 2);

			var metric = _ref22[0];
			var antimetric = _ref22[1];
			var staticMetric = this.props[metric];
			var staticAntimetric = this.props[antimetric];

			children = (children instanceof Array ? children : [children]).map(function (child) {
			...
			return _react2['default'].createElement(
				...
				{ style: (_ref = {
					...
					}, _defineProperty(_ref, metric, staticMetric || '100%'), _defineProperty(_ref, antimetric, staticAntimetric), _ref) },
				children
			);
		}
	}]);
